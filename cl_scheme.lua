...
if system.IsLinux() == false then
	...
	surface.CreateFont("HudClassHealth", {font = "tf2.ttf", size = 16*Scale})
	surface.CreateFont("HudClassHealthMax", {font = "DefaultSmall", size = 10*Scale})
	surface.CreateFont("HudFontMedium", {font = "tf2.ttf", size = 24*Scale})
	surface.CreateFont("HudFontMediumSmall", {font = "tf2.ttf", size = 18*Scale})
	surface.CreateFont("HudFontBig", {font = "tf2.ttf", size = 36*Scale})

	surface.CreateFont("HudFontSmallest", {font = "tf2secondary.ttf", size = 11*Scale})
	surface.CreateFont("HudFontSmall", {font = "tf2secondary.ttf", size = 14*Scale})
	surface.CreateFont("HudFontMediumSmallSecondary", {font = "tf2secondary.ttf", size = 18*Scale})

	surface.CreateFont("HudFontSmallestBold", {font = "tf2build.ttf", size = 11*Scale})
	surface.CreateFont("HudFontSmallBold", {font = "tf2build.ttf", size = 14*Scale})
	surface.CreateFont("HudFontMediumBold", {font = "tf2build.ttf", size = 24*Scale})
	surface.CreateFont("HudFontGiantBold", {font = "tf2build.ttf", size = 44*Scale})
	...
	surface.CreateFont("ChalkboardTitle", {font = "tf2professor.ttf", size = 28*Scale})
	surface.CreateFont("ChalkboardTitleBig", {font = "tf2professor.ttf", size = 40*Scale})
	surface.CreateFont("ChalkboardTitleMedium", {font = "tf2professor.ttf", size = 24*Scale})
	surface.CreateFont("ChalkboardText", {font = "tf2professor.ttf", size = 14*Scale})

	surface.CreateFont("MenuMainTitle", {font = "tf2.ttf", size = 24*Scale})
	surface.CreateFont("MenuClassBuckets", {font = "tf2secondary.ttf", size = 11*Scale})
	surface.CreateFont("ScoreboardSmallest", {font = "Verdana", size = 7*Scale, weight = 400})
	surface.CreateFont("ScoreboardVerySmall", {font = "Verdana", size = 8*Scale, weight = 400})
	surface.CreateFont("ScoreboardSmall", {font = "tf2secondary.ttf", size = 10*Scale, weight = 400})
	surface.CreateFont("ScoreboardMediumSmall", {font = "tf2.ttf", size = 14*Scale})
	surface.CreateFont("ScoreboardMedium", {font = "tf2secondary.ttf", size = 20*Scale})
	surface.CreateFont("ScoreboardTeamName", {font = "Ttf2secondary.ttf", size = 20*Scale})
	surface.CreateFont("ScoreboardTeamNameLarge", {font = "tf2secondary.ttf", size = 34*Scale})

	if H<600 then
		surface.CreateFont("TFDefault", {font = "Verdana", size = 12, weight = 900, antialias = false})
		surface.CreateFont("TFDefaultVerySmall", {font = "Verdana", size = 12, weight = 0, antialias = false})
		surface.CreateFont("TFDefaultSmall", {font = "Verdana", size = 12, weight = 0, antialias = false})
		surface.CreateFont("TFHudSelectionText", {font = "tf2.ttf", size = 15, weight = 700})
		surface.CreateFont("ScoreboardTeamScore", {font = "tf2.ttf", size = 52, weight = 400})
	elseif H<768 then
		surface.CreateFont("TFDefault", {font = "Verdana", size = 13, weight = 900, antialias = false})
		surface.CreateFont("TFDefaultVerySmall", {font = "Verdana", size = 12, weight = 0, antialias = false})
		surface.CreateFont("TFDefaultSmall", {font = "Verdana", size = 13, weight = 0, antialias = false})
		surface.CreateFont("TFHudSelectionText", {font = "tf2.ttf", size = 15, weight = 700})
		surface.CreateFont("ScoreboardTeamScore", {font = "tf2.ttf", size = 72, weight = 400})
	elseif H<1024 then
		surface.CreateFont("TFDefault", {font = "Verdana", size = 14, weight = 900})
		surface.CreateFont("TFDefaultVerySmall", {font = "Verdana", size = 12, weight = 0, antialias = false})
		surface.CreateFont("TFDefaultSmall", {font = "Verdana", size = 14, weight = 0})
		surface.CreateFont("TFHudSelectionText", {font = "tf2.ttf", size = 18, weight = 900})
		surface.CreateFont("ScoreboardTeamScore", {font = "tf2.ttf", size = 100, weight = 400})
	elseif H<1200 then
		surface.CreateFont("TFDefault", {font = "Verdana", size = 20, weight = 900})
		surface.CreateFont("TFDefaultVerySmall", {font = "Verdana", size = 14, weight = 0, antialias = false})
		surface.CreateFont("TFDefaultSmall", {font = "Verdana", size = 20, weight = 0})
		surface.CreateFont("TFHudSelectionText", {font = "tf2.ttf", size = 21, weight = 900})
		surface.CreateFont("ScoreboardTeamScore", {font = "tf2.ttf", size = 140, weight = 400})
	else
		surface.CreateFont("TFDefault", {font = "Verdana", size = 24, weight = 900})
		surface.CreateFont("TFDefaultVerySmall", {font = "Verdana", size = 16, weight = 0, antialias = false})
		surface.CreateFont("TFDefaultSmall", {font = "Verdana", size = 2, weight = 0})
		surface.CreateFont("TFHudSelectionText", {font = "tf2.ttf", size = 24, weight = 1000})
		surface.CreateFont("ScoreboardTeamScore", {font = "tf2.ttf", size = 180, weight = 400})
	end

	surface.CreateFont("ItemFontNameSmallest", {font = "tf2build.ttf", size = 8*Scale})
	surface.CreateFont("ItemFontNameSmall", {font = "tf2build.ttf", size = 9*Scale})
	surface.CreateFont("ItemFontNameLarge", {font = "tf2build.ttf", size = 12*Scale})

	surface.CreateFont("ItemFontAttribSmallest", {font = "tf2secondary.ttf", size = 7*Scale})
	surface.CreateFont("ItemFontAttribSmall", {font = "tf2secondary.ttf", size = 8*Scale})
	surface.CreateFont("ItemFontAttribLarge", {font = "tf2secondary.ttf", size = 11*Scale})
